...
const isRailway = typeof window !== 'undefined' && window.location.hostname === 'hikmaflow.up.railway.app';
...
export const API_BASE_URL = isRailway ? 'https://hikmaflow.up.railway.app' :
